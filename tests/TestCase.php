...
use Medianet\APIToolKit\APIToolKitServiceProvider;
use Medianet\APIToolKit\MacroServiceProvider;
...
abstract class TestCase extends OrchestraTestCase
{
    public function setUp(): void
    {
        ...
        Factory::guessFactoryNamesUsing(
            fn (string $modelName) => 'Medianet\\APIToolKit\\Tests\\database\\factories\\' . class_basename($modelName) . 'Factory'
        );
    }
