...
namespace Medianet\APIToolKit\Filters;

use Medianet\APIToolKit\Filters\DTO\FiltersDTO;
use Medianet\APIToolKit\Filters\Exceptions\MissingDefaultFiltersException;
